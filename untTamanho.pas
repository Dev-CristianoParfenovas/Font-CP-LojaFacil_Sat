...
uses
  ...
  Dialogs, Grids, DBGrids, StdCtrls, ExtCtrls, IBQuery, Data.DB;
...
begin
  ...
  ConfirmaGravacao := Application.MessageBox('Confirma o Lançamento','Grava Registro',+MB_YESNO+MB_DEFBUTTON1+MB_ICONQUESTION);
