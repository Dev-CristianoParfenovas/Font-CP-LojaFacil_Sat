object frmRelatServicosEmitidos: TfrmRelatServicosEmitidos
  Left = -4
  Top = -4
  Width = 808
  Height = 574
  HorzScrollBar.Position = 11
  Caption = 'Relatorio de Servi'#231'os'
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object qrpServicosEmitidos: TQuickRep
    Left = -11
    Top = -1
    Width = 794
    Height = 1123
    ...
    object PageHeaderBand1: TQRBand
      ...
      object qrimgCodBarras: TQRImage
        Left = 4
        Top = 33
        Width = 105
        Height = 30
      ...
      object qrdbTelefoneCliente: TQRDBText
        Left = 67
        Top = 183
        Width = 114
        Height = 17
      ...
      object qrdbFuncionario: TQRDBText
        Left = 636
        Top = 22
        Width = 78
        Height = 17
