object frmRelFluxoPrecoD: TfrmRelFluxoPrecoD
  Left = 186
  Top = 110
  Width = 544
  Height = 367
  HorzScrollBar.Position = 161
  Caption = 'frmRelFluxoPrecoD'
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object qrpFluxoCxPrecoD: TQuickRep
    Left = -160
    Top = 0
    Width = 794
    Height = 1123
    ...
    object PageHeaderBand1: TQRBand
      ...
      object qrl_Titulo: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Relat'#243'rio de Fluxo de Caixa Pre'#231'o(D)'
        Color = clInactiveCaptionText
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -16
