object frmRelFluxoPrecoB: TfrmRelFluxoPrecoB
  Left = 30
  Top = 96
  Width = 808
  Height = 578
  VertScrollBar.Position = 30
  Caption = 'frmRelFluxoPrecoB'
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object qrpFluxoCxPrecoB: TQuickRep
    Left = -2
    Top = -31
    Width = 794
    Height = 1123
    ...
    object PageHeaderBand1: TQRBand
      ...
      object qrl_Titulo: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Relat'#243'rio de Fluxo de Caixa Pre'#231'o(B)'
        Color = clInactiveCaptionText
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -16
