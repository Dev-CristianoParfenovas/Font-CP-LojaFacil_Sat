object frmFluxoPrecoA: TfrmFluxoPrecoA
  Left = -4
  Top = -4
  Width = 808
  Height = 574
  HorzScrollBar.Position = 10
  Caption = 'frmFluxoPrecoA'
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object qrpFluxoCxPrecoA: TQuickRep
    Left = -11
    Top = 0
    Width = 794
    Height = 1123
    ...
    object PageHeaderBand1: TQRBand
      ...
      object qrl_Titulo: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Relat'#243'rio de Fluxo de Caixa Pre'#231'o(A)'
        Color = clInactiveCaptionText
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -16
