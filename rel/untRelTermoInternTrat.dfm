object frmInternTrat: TfrmInternTrat
  Left = 186
  Top = 110
  Width = 544
  Height = 375
  Caption = 'Termos de Aut. para Intern./Tratamento'
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object qrpInternTrat: TQuickRep
    Left = 0
    Top = 0
    Width = 794
    Height = 1123
    ...
    object PageHeaderBand1: TQRBand
      ...
      object QRLabel1: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Autoriza'#231#227'o para Interna'#231#227'o/Tratamento'
        Color = clInactiveCaptionText
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -16
    ...
    object QRMemo1: TQRMemo
      ...
      Lines.Strings = (
          ...
          'Para fins de ordem legal, declaro que deixei o animal de minha p' +
          'ropriedade acima'
        
          'identificado, para interna'#231#227'o e/ou tratamento, n'#227'o cabendo nenhu' +
          'ma responsabi-'
        
          '-lidade aos M'#233'dicos Veterin'#225'rios em rela'#231#227'o aos poss'#237'veis riscos' +
          ' de vida do animal.'
