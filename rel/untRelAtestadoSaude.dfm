object frmRelAtestadoSaude: TfrmRelAtestadoSaude
  Left = 111
  Top = 80
  Width = 544
  Height = 375
  VertScrollBar.Position = 59
  Caption = 'Atestado de Sa'#250'de'
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object qrpAtestadoSaude: TQuickRep
    Left = 0
    Top = -60
    Width = 794
    Height = 1123
    ...
    object qrlAtesto: TQRLabel
      ...
      AutoSize = True
      AutoStretch = False
      Caption = 'Atesto para os devidos fins que examinei o animal citado acima.'
      Color = clWhite
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
    ...
    object qrlDiagnostico: TQRLabel
      ...
      AutoStretch = False
      Caption = 
        'O referido animal goza de boa sa'#250'de, e n'#227'o portador de Mol'#233'stia ' +
        'infecto contagiosa ou parasit'#243'ria. '
      Color = clWhite
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
