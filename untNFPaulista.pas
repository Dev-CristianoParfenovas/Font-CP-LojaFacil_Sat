...
uses untServicos, untRecebeLoja;
  ...
  VK_F1 :begin
    ...
    if frmVendasLoja.Showing Then begin
       ...
       if lbl_Nome.Text <> '' Then begin
         ...
         frmVendasLoja.lbl_Cliente.Caption := lbl_Nome.Text;
       ...
       if lbl_Cpf.Text <> '' Then begin
          ...
          frmVendasLoja.lbl_edtCnpjCpf.Caption := lbl_Cpf.Text;
          frmVendasLoja.lbl_CnpjCpfP.Caption := 'CPF:';
       ...
       if lbl_Cnpj.Text <> '' Then begin
          ...
          frmVendasLoja.lbl_edtCnpjCpf.Caption := lbl_Cnpj.Text;
          frmVendasLoja.lbl_CnpjCpfP.Caption := 'CNPJ:';
