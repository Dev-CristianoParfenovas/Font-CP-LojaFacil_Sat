object frmProd_MPrima: TfrmProd_MPrima
  ...
  object pcProdutos: TPageControl
    ...
    object tbsProduto: TTabSheet
      ...
      object pcCadProdutos: TPageControl
        Left = 0
        Top = 50
        Width = 785
        Height = 283
        ...
        object tbsProd: TTabSheet
          ...
          object lbl_edtVlrPacoteFardo: TLabeledEdit
            ...
            EditLabel.Width = 75
            EditLabel.Height = 13
            EditLabel.Caption = 'Vlr.Pct.Fardo'
            EditLabel.Font.Charset = DEFAULT_CHARSET
            EditLabel.Font.Color = clWindowText
            EditLabel.Font.Height = -11
            EditLabel.Font.Name = 'MS Sans Serif'
          ...
          object lbl_edtQtdePacoteFardo: TLabeledEdit
            ...
            OnExit = lbl_edtQtdePacoteFardoExit
          end
          ...
          object dtpVctoLote: TDateTimePicker
            ...
            BevelOuter = bvSpace
            BevelKind = bkFlat
            Date = 41548.000000000000000000
            Time = 0.986582384262874300
            TabOrder = 11
          end
          ...
          object pcProdET: TPageControl
            ...
            object tbsEstoque: TTabSheet
              Caption = 'Informacoes de Estoque'
              ImageIndex = 1
              ...
              object ckDiminuirEstoque: TCheckBox
                ...
                TabOrder = 3
                OnClick = ckDiminuirEstoqueClick
              end
              object ckAcrescentarEstoq: TCheckBox
                ...
                TabOrder = 4
                OnClick = ckAcrescentarEstoqClick
              end
            ...
            object tbsHistEstoq: TTabSheet
              Caption = 'Hist'#243'rico de Estoque'
              ImageIndex = 3
              object Label5: TLabel
                ...
                Height = 14
                Caption = 
                  'Na grade abaixo d'#234' um duplo clique no nome do produto para gerar' +
                  ' o hist'#243'rico de  entradas no estoque.'
          ...
          object lbl_edtLocalizacaoProd: TLabeledEdit
            Left = 74
            Top = 96
            Width = 147
            Height = 21
            ...
            MaxLength = 50
            TabOrder = 23
            OnEnter = lbl_edtComissaoProdEnter
            OnExit = lbl_edtComissaoProdExit
            OnKeyPress = lbl_edtComissaoProdKeyPress
          end
          object lbl_edtComissaoC: TLabeledEdit
            Left = 462
            Top = 19
            Width = 51
            Height = 22
            ...
            ParentFont = False
            TabOrder = 7
            OnEnter = lbl_edtComissaoCEnter
            OnExit = lbl_edtComissaoCExit
            OnKeyPress = lbl_edtComissaoCKeyPress
          end
        end
      ...
      object dbgProdutos: TDBGrid
        ...
        OnColEnter = dbgProdutosColEnter
      end
      ...
      object lbl_edtCodFabr: TLabeledEdit
        Left = 629
        Top = 18
        Width = 76
        Height = 21
        ...
        EditLabel.Width = 56
        EditLabel.Height = 13
        EditLabel.Caption = 'C'#243'd.Fabr.'
        EditLabel.Font.Charset = DEFAULT_CHARSET
        EditLabel.Font.Color = clWindowText
        EditLabel.Font.Height = -11
        EditLabel.Font.Name = 'MS Sans Serif'
        ...
        EditLabel.ParentFont = False
        TabOrder = 5
        OnEnter = lbl_edtCodFabrEnter
        OnExit = lbl_edtCodFabrExit
        OnKeyPress = lbl_edtCodFabrKeyPress
      end
      object lbl_edtComissaoProd: TLabeledEdit
        Left = 554
        Top = 18
        Width = 70
        Height = 21
      ...
      object lbl_edtBuscaCodFabr: TLabeledEdit
        Left = 603
        Top = 360
        Width = 97
        Height = 21
        ...
        ParentFont = False
        TabOrder = 18
        OnChange = lbl_edtBuscaCodFabrChange
        OnEnter = lbl_edtBuscaCodFabrEnter
        OnExit = lbl_edtBuscaCodFabrExit
      end
    end
    object TabSheet2: TTabSheet
      ...
      object pcFornecedores: TPageControl
        Left = 3
        Top = 104
        Width = 784
        Height = 440
