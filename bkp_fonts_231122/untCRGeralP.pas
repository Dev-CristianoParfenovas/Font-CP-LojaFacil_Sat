...
begin
  ...
  {  Commit(ibAReceber);
    ...
    ibTempAReceber.SQL.Add('SELECT TBLCONTASARECEBER.*,TBLCADASTRO.NOME,'
    + ' TBLTIPOPAGTOAVULSO.DESCRICAO As TipoDocCR FROM TBLCONTASARECEBER '
    ...
    + ' WHERE (TBLCONTASARECEBER.VCTO between :ParamDataInicial and :ParamDataF)and(TBLCONTASARECEBER.IDCLI>0 or TBLCONTASARECEBER.IDCLI=0) ORDER BY TBLCONTASARECEBER.VCTO ASC');
    ibTempAReceber.Open;
  ...
  //     qrdbTipoPagto.DataField   := ibAReceber.FieldByName('TipoDocCR').FieldName;
