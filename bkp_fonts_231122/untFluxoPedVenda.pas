  ...
  with dmModule do begin
    ...
    with dbgFluxoPed do begin
      ...
      if MontaColunas Then begin
        ...
        //Parametros da Coluna que exibe o vlr unitario do produto.
        Columns.Items[6].Title.Caption := 'Comissão';
...
begin
  ...
  with dmModule do begin
    ...
    ConfirmaComissao := Application.MessageBox('Confirma o lançamento','Lançar Comissão',+MB_YESNO+MB_DEFBUTTON1+MB_ICONQUESTION);
...
begin
  ...
  with dmModule do begin
    ...
    ConfirmaEstorno := Application.MessageBox('Confirma o estorno do lançamento','Estorno de lançamento',+MB_YESNO+MB_DEFBUTTON1+MB_ICONQUESTION);
