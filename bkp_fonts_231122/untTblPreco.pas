...
type
  TfrmTblPreco = class(TForm)
    ...
    GroupBox2: TGroupBox;
    ckPorcentagem: TCheckBox;
    ckValor: TCheckBox;
    ckGeral: TCheckBox;
    ckEstoqueZero: TCheckBox;
    ckPorcentagemCusto: TCheckBox;
    ckValorCusto: TCheckBox;
      ...
      if lbl_edtPorcentagem.Text <> '' Then begin
        ...
        if lbl_edtPorcentagem.Text <> '' Then begin// se for em branco executa rotina abaixo.
          ...
          if (Pos(',',lbl_edtPorcentagem.Text)>0) and (lbl_edtPorcentagem.Text <> '') Then begin
            ...
            ValorPorcentagem := StrToFloat(StringReplace(lbl_edtPorcentagem.Text,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
            ValorVenda := StrToFloat(StringReplace(FloatToStr(ibProdutos.FieldByName('VALORVENDAA').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
            ...
            Total := StringReplace(FloattoStr(Valor5),FormatSettings.ThousandSeparator,'',[rfReplaceAll]);
       ...
       if IDProduto > 0 Then begin
          ...
          if AutorizaAutEstoque Then begin
            ...
            TotalEstoque := StringReplace(FloattoStr(QtdeEstoque),FormatSettings.ThousandSeparator,'',[rfReplaceAll]);
            TotalEstoque := StringReplace(TotalEstoque,FormatSettings.DecimalSeparator,'.',[rfReplaceAll]);
        ...
        if lbl_edtPorcentagem.Text <> '' Then begin
          ...
          if lbl_edtPorcentagem.Text <> '' Then begin// se for em branco executa rotina abaixo.
            ...
            if (Pos(',',lbl_edtPorcentagem.Text)>0) and (lbl_edtPorcentagem.Text <> '') Then begin
              ...
              ValorAlteracao := StrToFloat(StringReplace(lbl_edtPorcentagem.Text,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
              Valor6 := StrToFloat(StringReplace(FloatToStr(ibProdutos.FieldByName('VALORVENDAA').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
              Valor7 := Valor6 + ValorAlteracao;

              Valor8 := Valor7;

              TotalSomado := StringReplace(FloattoStr(Valor8),FormatSettings.ThousandSeparator,'',[rfReplaceAll]);
              TotalSomado := StringReplace(TotalSomado,FormatSettings.DecimalSeparator,'.',[rfReplaceAll]);
      ...
      if lbl_edtValorCusto.Text <> '' Then begin
        ...
        if lbl_edtValorCusto.Text <> '' Then begin// se for em branco executa rotina abaixo.
          ...
          if (Pos(',',lbl_edtValorCusto.Text)>0) and (lbl_edtValorCusto.Text <> '') Then begin
            ...
            ValorPorcentagem := StrToFloat(StringReplace(lbl_edtValorCusto.Text,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
            ValorCusto := StrToFloat(StringReplace(FloatToStr(ibProdutos.FieldByName('VALORCUSTO').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
            ValorVenda := StrToFloat(StringReplace(FloatToStr(ibProdutos.FieldByName('VALORVENDAA').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
            Valor3 := ValorVenda * ValorPorcentagem;
        ...
        if lbl_edtValorCusto.Text <> '' Then begin
          ...
          if lbl_edtValorCusto.Text <> '' Then begin// se for em branco executa rotina abaixo.
            ...
            if (Pos(',',lbl_edtValorCusto.Text)>0) and (lbl_edtValorCusto.Text <> '') Then begin
              ...
              ValorAlteracao := StrToFloat(StringReplace(lbl_edtValorCusto.Text,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
              Valor6 := StrToFloat(StringReplace(FloatToStr(ibProdutos.FieldByName('VALORCUSTO').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
              Valor7 := Valor6 + ValorAlteracao;
