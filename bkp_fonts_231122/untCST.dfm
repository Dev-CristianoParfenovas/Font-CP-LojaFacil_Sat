object frmCST: TfrmCST
  ...
  object lbl_edtCodCST: TLabeledEdit
    Left = 8
    Top = 104
    Width = 65
    Height = 21
    ...
    MaxLength = 7
    TabOrder = 0
    OnEnter = lbl_edtCodCSTEnter
    OnExit = lbl_edtCodCSTExit
    OnKeyPress = lbl_edtCodCSTKeyPress
  end
  object lbl_edtDescrCST: TLabeledEdit
    Left = 88
    Top = 104
    Width = 298
    Height = 21
    ...
    MaxLength = 110
    TabOrder = 1
    OnEnter = lbl_edtDescrCSTEnter
    OnExit = lbl_edtDescrCSTExit
  end
  object dbgCST: TDBGrid
    Left = 7
    Top = 140
    Width = 378
    Height = 216
