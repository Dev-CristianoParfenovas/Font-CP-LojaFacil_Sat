...
uses
  ...
  Dialogs, ExtCtrls, mxFlatControls, Grids, DBGrids, StdCtrls,
  IBEAntialiasButton, classComboBox, Menus, IBQuery;

type
  TfrmGrupo_Subgrupo = class(TForm)
    Image1: TImage;
    lblGrupo: TLabel;
...
var
  frmGrupo_Subgrupo: TfrmGrupo_Subgrupo;
  MontaColunasGrupo : Boolean; //VARIAVEL USADA PARA DETERMINAR SE A COLUNA JÀ FOI CRIADA OU NÃO
...
procedure TfrmGrupo_Subgrupo.Commit(IBQueryExec : TIBQuery);
begin
...
procedure TfrmGrupo_Subgrupo.DesabilitaGrupo(opcao : Boolean);
begin
...
procedure TfrmGrupo_Subgrupo.DesabilitaSubGrupo(opcao : Boolean);
begin
...
procedure TfrmGrupo_Subgrupo.ExibeGrupo;
//var
//i : Integer;
...
procedure TfrmGrupo_Subgrupo.ExibeSubgrupo;
begin
...
procedure TfrmGrupo_Subgrupo.AlteraCadastro;
begin
 with dmModule do begin
...
procedure TfrmGrupo_Subgrupo.AlteraSubgrupo;
begin
...
procedure TfrmGrupo_Subgrupo.ExecSELECT;
begin

  with dmModule do begin

   //BUSCA TODOS OS GRUPOS QUE ESTEJAM NA CLASSIFICAÇÃO DE GRUPO
...
procedure TfrmGrupo_Subgrupo.ExecSELECTSubgrupo;
begin
...
procedure TfrmGrupo_Subgrupo.FormShow(Sender: TObject);
begin
    ...
    ibeaIncluir.Enabled := False;
      ...
      // monta as colunas abaixo se for verdadeiro
        if MontaColunasGrupo Then begin
          ...
          //Parametros da Coluna que exibe o Código do Grupo e Subgrupo
...
procedure TfrmGrupo_Subgrupo.FormCreate(Sender: TObject);
begin
...
procedure TfrmGrupo_Subgrupo.ibeaSairClick(Sender: TObject);
begin
  Close;
end;

procedure TfrmGrupo_Subgrupo.ibeaNovoClick(Sender: TObject);
begin
...
procedure TfrmGrupo_Subgrupo.ibeaAlterarClick(Sender: TObject);
...
procedure TfrmGrupo_Subgrupo.ibeaIncluirClick(Sender: TObject);
begin
...
procedure TfrmGrupo_Subgrupo.ibeaPrimeiroClick(Sender: TObject);
begin
  with dmModule do begin
...
procedure TfrmGrupo_Subgrupo.ibeaAnteriorClick(Sender: TObject);
begin
  with dmModule do begin
     if ibeaAlterar.Caption = '&Atualizar' Then begin
...
procedure TfrmGrupo_Subgrupo.ibeaProximoClick(Sender: TObject);
begin
...
procedure TfrmGrupo_Subgrupo.ibeaUltimoClick(Sender: TObject);
begin
...
procedure TfrmGrupo_Subgrupo.cboGrupoClick(Sender: TObject);
begin
  ...
  with dmModule do begin
      ...
      // ao clicar no combo sera feita a select do grupo selecionado onde o id da variavel classe  é igual ao vlr do field idgrupo
      ibGrupo.Close;
      ibGrupo.SQL.Clear;
...
procedure TfrmGrupo_Subgrupo.dbgGrupoCellClick(Column: TColumn);
begin
  with dmModule do begin
...
procedure TfrmGrupo_Subgrupo.dbgSubgrupoCellClick(Column: TColumn);
begin
  with dmModule do begin
...
procedure TfrmGrupo_Subgrupo.AlterarSubGrupoClick(Sender: TObject);
var
...
begin
  ...
  with dmModule do begin
   ...
   PromptString(Self,'Alteração de SubGrupo','Informe o nome para o SubGrupo',StringSubGrupo);
