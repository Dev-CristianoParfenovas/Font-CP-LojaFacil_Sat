object frmCFOP: TfrmCFOP
  ...
  object lbl_edtCodCFOP: TLabeledEdit
    Left = 8
    Top = 104
    Width = 65
    Height = 21
    ...
    EditLabel.Width = 59
    EditLabel.Height = 13
    EditLabel.Caption = 'C'#243'd.CFOP'
    ...
    MaxLength = 7
    TabOrder = 0
    OnEnter = lbl_edtCodCFOPEnter
    OnExit = lbl_edtCodCFOPExit
    OnKeyPress = lbl_edtCodCFOPKeyPress
  end
  object lbl_edtDescrCFOP: TLabeledEdit
    Left = 88
    Top = 104
    Width = 298
    Height = 21
    ...
    MaxLength = 110
    TabOrder = 1
    OnEnter = lbl_edtDescrCFOPEnter
    OnExit = lbl_edtDescrCFOPExit
  end
  object dbgCFOP: TDBGrid
    Left = 7
    Top = 140
    Width = 378
    Height = 216
