...
uses
  ...
  Dialogs, BmsXPCheckBox, BmsXPButton, DB, IBQuery,
  StdCtrls;
...
type
  TfrmPimaco6087 = class(TForm)
    ...
    GroupBox2: TGroupBox;
    ckImprimirCompleto: TBmsXPCheckBox;
    ...
    procedure ckImprimirCompletoCheck(Sender: TObject);
...
procedure TfrmPimaco6087.ckImprimirCompletoCheck(Sender: TObject);
begin
...
procedure TfrmPimaco6087.ckImprimirRefCheck(Sender: TObject);
begin
