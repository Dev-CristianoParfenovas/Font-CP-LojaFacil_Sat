  ...
  with dmModule do begin
    ...
    with dbgEntradaestoque do begin
      ...
      if MontaColunas Then begin
        ...
        Columns.Items[3].Title.Caption := 'Estoque Mínimo';
...
////////////////////////////////////////////////////////////////////////////////
      ...
      if ibeaNovo.Caption = '&Gravar'Then begin
        ...
        If cboEstoque.ItemIndex = -1 Then begin
          ...
          //   Application.MessageBox('Gravar sem o Fornecedor?','Notificação: Fornecedor não especificado',MB_YESNO + MB_ICONQUESTION);
             StringFornecedor    := ' ''0'',';
          ...
          //   Application.MessageBox('Informe o Fornecedor','Notificação: Fornecedor não especificado',MB_YESNO + MB_ICONERROR);
             StringNatureza    := ' ''0'',';
...
begin
  ...
  with dmModule do begin
    ...
    if cboProduto.ItemIndex <> -1 Then begin
      ...
      //DEFINE QUAL SERÁ O CÓDIGO DO PRODUTO SELECIONADO
