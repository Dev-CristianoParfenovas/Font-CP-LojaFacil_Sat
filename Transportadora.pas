...
//  IDClassCnpj: Integer;// variavel para armazenar a classificação do campo cnpj
  IDClassCelular: Integer;// variavel para armazenar a classificação do campo celular.
  ...
  IDClassVeiculo: Integer;// variavel para armazenar a classificação do campo veiculo.
  IDClassPlaca: Integer;// variavel para armazenar a classificação do campo placa.
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  //ROTINA PARA ALTERAR O VEICULO
   { if lbl_edtVeiculo.Text <> '' Then begin
     ...
     //inicio de rotina para gravação de contato
    //localiza e abre somente o cadastro de contato pela identificação do veiculo
      ibClassificacao.Close;
      ibClassificacao.SQL.Clear;
...
begin
  with dmModule do begin
    ...
    ibClassificacao.Open;
    IDClass := ibClassificacao.FieldByName('IDCLASS').AsInteger; // ATRIBUI A IDENTIFICAÇÃO DA TRANSPORTADORA NA VARIAVEL.
    ...
    {    //BUSCA TODAS AS TRANSPORTADORAS QUE ESTEJAM NA CLASSIFICAÇÃO DE TRANSPORTADORAS
    ibCadastro.Close;
    ibCadastro.SQL.Clear;
