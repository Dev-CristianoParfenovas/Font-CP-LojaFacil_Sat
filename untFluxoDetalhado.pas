     ...
     /// ibAPagar.Close;
      ...
      while not ibAPagar.Eof do begin
        ...
        if VlrCP = 0 Then begin
          ...
          VlrCP := StrToFloat(StringReplace(FloatToStr(ibAPagar.FieldByName('VLREMITIDO').AsFloat),FormatSettings.ThousandSeparator,'',[rfreplaceAll]));

        end else begin

          TotalCP := StringReplace(FloatToStr(ibAPagar.FieldByName('VLREMITIDO').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]);

          VlrCP := VlrCP + StrtoFloat(StringReplace(TotalCP,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
      ...
      while not ibTempAReceber.Eof do begin
        ...
        if VlrCR = 0 Then begin
          ...
          VlrCR := StrToFloat(StringReplace(FloatToStr(ibTempAReceber.FieldByName('VLREMITIDO').AsFloat),FormatSettings.ThousandSeparator,'',[rfreplaceAll]));
          ...
          VlrCR := VlrCR + StrtoFloat(StringReplace(TotalCR,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
      ...
      while not ibServsVenda.Eof do begin
        ...
        if TotalSangria = 0 Then begin
          ...
          TotalSangria := StrToFloat(StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRSANGRIA').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

        end else begin

          VlrSangria := (StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRSANGRIA').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

          TotalSangria := TotalSangria + StrToFloat(StringReplace(VlrSangria,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
         ...
         if ibServsVenda.FieldByName('VLRTOTAL').AsInteger > 0 Then begin
           ...
           if TotalGeral = 0 Then begin
             ...
             TotalGeral := StrToFloat(StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

           end else begin

             VlrGeral := (StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
        ...
        if ibServsVenda.FieldByName('IDTIPOPAGTO').AsInteger = IDDinheiro Then begin
          ...
          if TotalDinheiro = 0 Then begin
            ...
            TotalDinheiro := StrToFloat(StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

          end else begin

            VlrDinheiro := (StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
         ...
         if ibServsVenda.FieldByName('IDTIPOPAGTO').AsInteger = IDCheque Then begin
           ...
           if TotalCheque = 0 Then begin
             ...
             TotalCheque := StrToFloat(StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

           end else begin

             VlrCheque := (StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
         ...
         if ibServsVenda.FieldByName('IDTIPOPAGTO').AsInteger = IDChequePre Then begin
           ...
           if TotalChequePre = 0 Then begin
             ...
             TotalChequePre := StrToFloat(StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

           end else begin

             VlrChequePre := (StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
         ...
         if ibServsVenda.FieldByName('IDTIPOPAGTO').AsInteger = IDVisaCredito Then begin
           ...
           if TotalVisaCredito = 0 Then begin
             ...
             TotalVisaCredito := StrToFloat(StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

           end else begin

             VlrVisaCredito := (StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
         ...
         if ibServsVenda.FieldByName('IDTIPOPAGTO').AsInteger = IDVisaDebito Then begin
           ...
           if TotalVisaDebito = 0 Then begin
             ...
             TotalVisaDebito := StrToFloat(StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

           end else begin

             VlrVisaDebito := (StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
         ...
         if ibServsVenda.FieldByName('IDTIPOPAGTO').AsInteger = IDVisaParcelado Then begin
           ...
           if TotalVisaParcelado = 0 Then begin
             ...
             TotalVisaParcelado := StrToFloat(StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

           end else begin

             VlrVisaParcelado := (StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
         ...
         if ibServsVenda.FieldByName('IDTIPOPAGTO').AsInteger = IDMastercardCredito Then begin
           ...
           if TotalMastercardCredito = 0 Then begin
             ...
             TotalMastercardCredito := StrToFloat(StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

           end else begin

             VlrMastercardCredito := (StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
       ...
       if ibServsVenda.FieldByName('IDTIPOPAGTO').AsInteger = IDMastercardParcelado Then begin
           ...
           if TotalMastercardParcelado = 0 Then begin
             ...
             TotalMastercardParcelado := StrToFloat(StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

           end else begin

             VlrMastercardParcelado := (StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
       ...
       if ibServsVenda.FieldByName('IDTIPOPAGTO').AsInteger = IDMastercardDebito Then begin
           ...
           if TotalMastercardDebito = 0 Then begin
             ...
             TotalMastercardDebito := StrToFloat(StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

           end else begin

             VlrMastercardDebito := (StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

             TotalMastercardDebito := TotalMastercardDebito + StrToFloat(StringReplace(VlrMastercardDebito,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
       ...
       if ibServsVenda.FieldByName('IDTIPOPAGTO').AsInteger = IDHipercard Then begin
           ...
           if TotalHipercard = 0 Then begin
             ...
             TotalHipercard := StrToFloat(StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

           end else begin

             VlrHipercard := (StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
       ...
       if ibServsVenda.FieldByName('IDTIPOPAGTO').AsInteger = IDHCParc Then begin
           ...
           if VlrHipercardParc = 0 Then begin
             ...
             VlrHipercardParc := StrToFloat(StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

           end else begin

             VlrHCParc := (StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

             VlrHipercardParc := VlrHipercardParc + StrToFloat(StringReplace(VlrHCParc,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
       ...
       if ibServsVenda.FieldByName('IDTIPOPAGTO').AsInteger = IDAmericanExpress Then begin
           ...
           if TotalAmericanExpress = 0 Then begin
             ...
             TotalAmericanExpress := StrToFloat(StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

           end else begin

             VlrAmericanExpress := (StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
       ...
       if ibServsVenda.FieldByName('IDTIPOPAGTO').AsInteger = IDSoroCred Then begin
           ...
           if TotalSoroCred = 0 Then begin
             ...
             TotalSoroCred := StrToFloat(StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

           end else begin

             VlrSoroCred := (StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
       ...
       if ibServsVenda.FieldByName('IDTIPOPAGTO').AsInteger = IDPendente Then begin
           ...
           if TotalPendente = 0 Then begin
             ...
             TotalPendente := StrToFloat(StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

           end else begin

             VlrPendente := (StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
       ...
       if ibServsVenda.FieldByName('IDTIPOPAGTO').AsInteger = IDSodex Then begin
           ...
           if TotalSodex = 0 Then begin
             ...
             TotalSodex := StrToFloat(StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

           end else begin

             VlrPagoSodex := (StringReplace(FloatToStr(ibServsVenda.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

             TotalSodex := TotalSodex + StrToFloat(StringReplace(VlrPagoSodex,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
         ...
         if TotalAcrescimo = 0 Then begin
           ...
           TotalAcrescimo := StrToFloat(StringReplace(FloatToStr(ibServsVenda.FieldByName('ACRESCIMO').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

         end else begin

           VlrAcrescimo := (StringReplace(FloatToStr(ibServsVenda.FieldByName('ACRESCIMO').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

           TotalAcrescimo := TotalAcrescimo + StrToFloat(StringReplace(VlrAcrescimo,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
if (lbl_edtVisaCredito.Text <> '') or (lbl_edtVisaCredito.Text >'0,00') Then begin
  ...
  if lbl_edtTxVisaCredito.Text <> '' Then begin// se for em branco executa rotina abaixo.
    ...
    if (Pos(',',lbl_edtTxVisaCredito.Text)>0) and (lbl_edtTxVisaCredito.Text <> '') Then begin
      ...
      VisaCredito1 := StrToFloat(StringReplace(lbl_edtTxVisaCredito.Text,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
      VisaCredito2 := StrToFloat(StringReplace(lbl_edtVisaCredito.Text,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
if (lbl_edtVisaDebito.Text <> '') or (lbl_edtVisaDebito.Text >'0,00') Then begin
  ...
  if lbl_edtTxVisaDebito.Text <> '' Then begin// se for em branco executa rotina abaixo.
    ...
    if (Pos(',',lbl_edtTxVisaDebito.Text)>0) and (lbl_edtTxVisaDebito.Text <> '') Then begin
      ...
      VisaDebito1 := StrToFloat(StringReplace(lbl_edtTxVisaDebito.Text,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
      VisaDebito2 := StrToFloat(StringReplace(lbl_edtVisaDebito.Text,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
if (lbl_edtVisaParcelado.Text <> '') or (lbl_edtVisaParcelado.Text >'0,00') Then begin
  ...
  if lbl_edtTxVisaParcelado.Text <> '' Then begin// se for em branco executa rotina abaixo.
    ...
    if (Pos(',',lbl_edtTxVisaParcelado.Text)>0) and (lbl_edtTxVisaParcelado.Text <> '') Then begin
      ...
      VisaParcelado1 := StrToFloat(StringReplace(lbl_edtTxVisaParcelado.Text,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
      VisaParcelado2 := StrToFloat(StringReplace(lbl_edtVisaParcelado.Text,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
if (lbl_edtMastercardCredito.Text <> '') or (lbl_edtMastercardCredito.Text >'0,00') Then begin
  ...
  if lbl_edtTxMastercardCredito.Text <> '' Then begin// se for em branco executa rotina abaixo.
    ...
    if (Pos(',',lbl_edtTxMastercardCredito.Text)>0) and (lbl_edtTxMastercardCredito.Text <> '') Then begin
      ...
      MastercardCredito1 := StrToFloat(StringReplace(lbl_edtTxMastercardCredito.Text,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
      MastercardCredito2 := StrToFloat(StringReplace(lbl_edtMastercardCredito.Text,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
if (lbl_edtMastercardDebito.Text <> '') or (lbl_edtMastercardDebito.Text >'0,00') Then begin
  ...
  if lbl_edtTxMastercardDebito.Text <> '' Then begin// se for em branco executa rotina abaixo.
    ...
    if (Pos(',',lbl_edtTxMastercardDebito.Text)>0) and (lbl_edtTxMastercardDebito.Text <> '') Then begin
      ...
      MastercardDebito1 := StrToFloat(StringReplace(lbl_edtTxMastercardDebito.Text,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
      MastercardDebito2 := StrToFloat(StringReplace(lbl_edtMastercardDebito.Text,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
if (lbl_edtMastercardParcelado.Text <> '') or (lbl_edtMastercardParcelado.Text >'0,00') Then begin
  ...
  if lbl_edtTxMastercardParcelado.Text <> '' Then begin// se for em branco executa rotina abaixo.
    ...
    if (Pos(',',lbl_edtTxMastercardParcelado.Text)>0) and (lbl_edtTxMastercardParcelado.Text <> '') Then begin
      ...
      MastercardParcelado1 := StrToFloat(StringReplace(lbl_edtTxMastercardParcelado.Text,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
      MastercardParcelado2 := StrToFloat(StringReplace(lbl_edtMastercardParcelado.Text,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
if (lbl_edtHipercard.Text <> '') or (lbl_edtHipercard.Text >'0,00') Then begin
  ...
  if lbl_edtHipercard.Text <> '' Then begin// se for em branco executa rotina abaixo.
    ...
    if (Pos(',',lbl_edtHipercard.Text)>0) and (lbl_edtHipercard.Text <> '') Then begin
      ...
      VlrTotalHiperCard := StrToFloat(StringReplace(lbl_edtTxHipercard.Text,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
      VlrTotalHiperCard2 := StrToFloat(StringReplace(lbl_edtHipercard.Text,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
if (lbl_edtHCParcelado.Text <> '') or (lbl_edtHCParcelado.Text >'0,00') Then begin
  ...
  if lbl_edtHCParcelado.Text <> '' Then begin// se for em branco executa rotina abaixo.
    ...
    if (Pos(',',lbl_edtHCParcelado.Text)>0) and (lbl_edtHCParcelado.Text <> '') Then begin
      ...
      VlrHipercardParc1 := StrToFloat(StringReplace(lbl_edtTxHCParcelado.Text,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
      VlrHipercardParc2 := StrToFloat(StringReplace(lbl_edtHCParcelado.Text,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
         ...
         if ibRecVendas.FieldByName('IDTIPOPAGTO').AsInteger = IDChequeEletronico Then begin
           ...
           if TotalChequeEletr = 0 Then begin
             ...
             TotalChequeEletr := StrToFloat(StringReplace(FloatToStr(ibRecVendas.FieldByName('TOTALVENDA').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

           end else begin

             VlrChequeEletr := (StringReplace(FloatToStr(ibRecVendas.FieldByName('TOTALVENDA').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

             TotalChequeEletr := TotalChequeEletr + StrToFloat(StringReplace(VlrChequeEletr,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
         ...
         if ibRecVendas.FieldByName('IDTIPOPAGTO').AsInteger = IDChequeEletronicoPre Then begin
           ...
           if TotalChequeEletrPre = 0 Then begin
             ...
             TotalChequeEletrPre := StrToFloat(StringReplace(FloatToStr(ibRecVendas.FieldByName('TOTALVENDA').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

           end else begin

             VlrChequeEletrPre := (StringReplace(FloatToStr(ibRecVendas.FieldByName('TOTALVENDA').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

             TotalChequeEletrPre := TotalChequeEletrPre + StrToFloat(StringReplace(VlrChequeEletrPre,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
         ...
         if ibRecVendas.FieldByName('IDTIPOPAGTO').AsInteger = IDVisa Then begin
           ...
           if TotalVisa = 0 Then begin
             ...
             TotalVisa := StrToFloat(StringReplace(FloatToStr(ibRecVendas.FieldByName('TOTALVENDA').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

           end else begin

             VlrVisa := (StringReplace(FloatToStr(ibRecVendas.FieldByName('TOTALVENDA').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

             TotalVisa := TotalVisa + StrToFloat(StringReplace(VlrVisa,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
         ...
         if ibRecVendas.FieldByName('IDTIPOPAGTO').AsInteger = IDVisaElectron Then begin
           ...
           if TotalVisaElectron = 0 Then begin
             ...
             TotalVisaElectron := StrToFloat(StringReplace(FloatToStr(ibRecVendas.FieldByName('TOTALVENDA').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

           end else begin

             VlrVisaElectron := (StringReplace(FloatToStr(ibRecVendas.FieldByName('TOTALVENDA').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

             TotalVisaElectron := TotalVisaElectron + StrToFloat(StringReplace(VlrVisaElectron,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
         ...
         if ibRecVendas.FieldByName('IDTIPOPAGTO').AsInteger = IDVisaElectronPre Then begin
           ...
           if TotalVisaElectronPre = 0 Then begin
             ...
             TotalVisaElectronPre := StrToFloat(StringReplace(FloatToStr(ibRecVendas.FieldByName('TOTALVENDA').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

           end else begin

             VlrVisaElectronPre := (StringReplace(FloatToStr(ibRecVendas.FieldByName('TOTALVENDA').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

             TotalVisaElectronPre := TotalVisaElectronPre + StrToFloat(StringReplace(VlrVisaElectronPre,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
         ...
         if ibRecVendas.FieldByName('IDTIPOPAGTO').AsInteger = IDMastercard Then begin
           ...
           if TotalMastercard = 0 Then begin
             ...
             TotalMastercard := StrToFloat(StringReplace(FloatToStr(ibRecVendas.FieldByName('TOTALVENDA').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

           end else begin

             VlrMastercard := (StringReplace(FloatToStr(ibRecVendas.FieldByName('TOTALVENDA').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

             TotalMastercard := TotalMastercard + StrToFloat(StringReplace(VlrMastercard,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
       ...
       if ibRecVendas.FieldByName('IDTIPOPAGTO').AsInteger = IDRedeShop Then begin
           ...
           if TotalRedeShop = 0 Then begin
             ...
             TotalRedeShop := StrToFloat(StringReplace(FloatToStr(ibRecVendas.FieldByName('TOTALVENDA').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

           end else begin

             VlrRedeShop := (StringReplace(FloatToStr(ibRecVendas.FieldByName('TOTALVENDA').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

             TotalRedeShop := TotalRedeShop + StrToFloat(StringReplace(VlrRedeShop,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
       ...
       if ibRecVendas.FieldByName('IDTIPOPAGTO').AsInteger = IDGoodCard Then begin
           ...
           if TotalGoodCard = 0 Then begin
             ...
             TotalGoodCard := StrToFloat(StringReplace(FloatToStr(ibRecVendas.FieldByName('TOTALVENDA').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

           end else begin

             VlrGoodCard := (StringReplace(FloatToStr(ibRecVendas.FieldByName('TOTALVENDA').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

             TotalGoodCard := TotalGoodCard + StrToFloat(StringReplace(VlrGoodCard,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
       ...
       if ibRecVendas.FieldByName('IDTIPOPAGTO').AsInteger = IDDinners Then begin
           ...
           if TotalDinners = 0 Then begin
             ...
             TotalDinners := StrToFloat(StringReplace(FloatToStr(ibRecVendas.FieldByName('TOTALVENDA').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

           end else begin

             VlrDinners := (StringReplace(FloatToStr(ibRecVendas.FieldByName('TOTALVENDA').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

             TotalDinners := TotalDinners + StrToFloat(StringReplace(VlrDinners,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
////////////////////////////////////////////////////////////////////////////////
       ...
       if ibRecVendas.FieldByName('IDTIPOPAGTO').AsInteger = IDSodex Then begin
           ...
           if TotalSodex = 0 Then begin
             ...
             TotalSodex := StrToFloat(StringReplace(FloatToStr(ibRecVendas.FieldByName('TOTALVENDA').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

           end else begin

             VlrPagoSodex := (StringReplace(FloatToStr(ibRecVendas.FieldByName('TOTALVENDA').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
if (lbl_edtTotalRecebido.Text <> '') or (lbl_edtTotalRecebido.Text >'0,00') Then begin
  ...
  if lbl_edtTotalRecebido.Text <> '' Then begin// se for em branco executa rotina abaixo.
    ...
    if (Pos(',',lbl_edtMargemLucro.Text)>0) and (lbl_edtMargemLucro.Text <> '') Then begin
      ...
      TotalVendaBruta := StrToFloat(StringReplace(lbl_edtTotalRecebido.Text,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
      MargemLucro := StrToFloat(StringReplace(lbl_edtMargemLucro.Text,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
